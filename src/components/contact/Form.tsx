        ...
        <form className="-mt-20 bg-white shadow-lg mx-5 md:mx-10 rounded-xl mb-20" autoComplete='off'>
            <div className='grid grid-cols-1 md:grid-cols-2'>
                ...
                <div className="py-10 ml-4">
                        ...
                        <Image
                            alt='icon'
                            className='absolute top-[125%] right-[16%] md:right-[7rem] md:top-[99%] lg:right-[7rem] lg:top-[100%]'
                            src='/Group.png'
                            width={20}
                            height={16}
                            priority/>
                ...
                <div className="pb-10 ml-4 lg:ml-14">
                        ...
                        <Image
                            alt='icon'
                            className='absolute top-[140%] right-[16%] md:right-[30rem] md:top-[123%] lg:right-[43rem] lg:top-[120%]'
                            src='/ming.png'
                            width={20}
                            height={16}
                            priority/>
                ...
                <div className="ml-4">
                        ...
                        <Image
                            alt='icon'
                            className='absolute top-[157%] right-[16%] md:right-[7rem] md:top-[123%] lg:right-[7rem] lg:top-[120%]'
                            src='/Group.png'
                            width={20}
                            height={16}
                            priority/>
                ...
                <label className="text-xl font-semibold">Message Body <span className=''>*</span></label> <br />
                    ...
                    <Image
                            alt='icon'
                            className='absolute top-[170%] right-[4rem]  md:top-[175%] lg:right-[7rem] lg:top-[162%]'
                            src='/mes.png'
                            width={20}
                            height={16}
                            priority/>
